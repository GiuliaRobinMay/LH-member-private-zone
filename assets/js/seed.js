...
/* The team who answers: Tony, Misty and Rose. Their real profile photos
   ...
   until then the illustrated mock-up portraits below stand in. Rose's
   photo and full name are still to come. */
...
/* Mock-up portraits (flat illustrations, not likenesses) for the demo. */
window.LZ_SEED.teamArt = {
  "Tony Woodworth": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><defs><clipPath id='c'><circle cx='32' cy='32' r='32'/></clipPath></defs><g clip-path='url(#c)'><rect width='64' height='64' fill='#d9e2f5'/><path d='M8 66c0-13 10-21 24-21s24 8 24 21z' fill='#2e43c8'/><rect x='26' y='34' width='12' height='12' rx='4' fill='#c9895e'/><ellipse cx='32' cy='27' rx='11.5' ry='13' fill='#d99a6c'/><path d='M22.5 30c1 7 4.5 10.5 9.5 10.5S40.5 37 41.5 30c-1.5 4.5-4.5 7-9.5 7s-8-2.5-9.5-7z' fill='#2a1f17' opacity='.5'/><path d='M20.5 27c-.5-10 5-15.5 11.5-15.5S44 17 43.5 27c-1.5-5.5-5.5-8-11.5-8s-10 2.5-11.5 8z' fill='#2a1f17'/><path d='M25 23.5h5M34 23.5h5' stroke='#2a1f17' stroke-width='1.4' stroke-linecap='round'/><circle cx='27.5' cy='27' r='1.4' fill='#22180f'/><circle cx='36.5' cy='27' r='1.4' fill='#22180f'/><path d='M28.5 33q3.5 2.2 7 0' stroke='#8a4a30' stroke-width='1.3' fill='none' stroke-linecap='round'/></g></svg>",
  "Misty Fowlds": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><defs><clipPath id='c'><circle cx='32' cy='32' r='32'/></clipPath></defs><g clip-path='url(#c)'><rect width='64' height='64' fill='#fbe3d6'/><path d='M18 30c0-12 6-18 14-18s14 6 14 18v20H18z' fill='#3b2314'/><path d='M8 66c0-13 10-21 24-21s24 8 24 21z' fill='#e8453c'/><path d='M18 30v22c3.5 0 6.5-4 6.5-9V30zM46 30v22c-3.5 0-6.5-4-6.5-9V30z' fill='#3b2314'/><rect x='26' y='34' width='12' height='12' rx='4' fill='#a86a48'/><ellipse cx='32' cy='27' rx='11.5' ry='13' fill='#b97a55'/><path d='M20.5 26c0-9 5-14 11.5-14S43.5 17 43.5 26c-3-4-6-6-11.5-6S23.5 22 20.5 26z' fill='#3b2314'/><path d='M25 23.5h5M34 23.5h5' stroke='#3b2314' stroke-width='1.3' stroke-linecap='round'/><circle cx='27.5' cy='27' r='1.4' fill='#22180f'/><circle cx='36.5' cy='27' r='1.4' fill='#22180f'/><path d='M28.5 33q3.5 2.2 7 0' stroke='#8a3a3a' stroke-width='1.3' fill='none' stroke-linecap='round'/></g></svg>",
  "Rose": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><defs><clipPath id='c'><circle cx='32' cy='32' r='32'/></clipPath></defs><g clip-path='url(#c)'><rect width='64' height='64' fill='#dff1e6'/><path d='M19 29c0-11 5.5-16 13-16s13 5 13 16v9c0 3-2.5 5-5.5 5h-15C21.5 43 19 41 19 38z' fill='#cfd4da'/><path d='M8 66c0-13 10-21 24-21s24 8 24 21z' fill='#2e9e5b'/><rect x='26' y='34' width='12' height='12' rx='4' fill='#e2b393'/><ellipse cx='32' cy='27' rx='11.5' ry='13' fill='#efc4a5'/><path d='M20.5 27c0-10 5-14.5 11.5-14.5S43.5 17 43.5 27c-2.5-5-6-7-11.5-7s-9 2-11.5 7z' fill='#dfe3e8'/><circle cx='27.5' cy='28' r='4.2' fill='none' stroke='#3a3a3a' stroke-width='1.2'/><circle cx='36.5' cy='28' r='4.2' fill='none' stroke='#3a3a3a' stroke-width='1.2'/><path d='M31.7 28h.6' stroke='#3a3a3a' stroke-width='1.2'/><circle cx='27.5' cy='28' r='1.4' fill='#2b2b2b'/><circle cx='36.5' cy='28' r='1.4' fill='#2b2b2b'/><path d='M28.5 34q3.5 2.2 7 0' stroke='#b0655a' stroke-width='1.3' fill='none' stroke-linecap='round'/></g></svg>",
  "Lesko Help Team": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><defs><clipPath id='c'><circle cx='32' cy='32' r='32'/></clipPath></defs><g clip-path='url(#c)'><rect width='64' height='64' fill='#e9ecf1'/><circle cx='32' cy='25' r='11' fill='#b6bdca'/><path d='M9 66c0-13 10-21 23-21s23 8 23 21z' fill='#b6bdca'/></g></svg>"
};
